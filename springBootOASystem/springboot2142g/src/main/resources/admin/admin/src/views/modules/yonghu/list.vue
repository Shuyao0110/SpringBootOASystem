<template>
  <div class="main-content">
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('yonghu','工资') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="gongzixinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'工资':'' }}</el-button>
                <el-button v-if="isAuth('yonghu','工资') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="gongzixinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'工资':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yonghu','工资') && contents.tableBtnIcon == 0" type="success" size="mini" @click="gongzixinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'工资':'' }}</el-button>
    ...
    <gongzixinxi-cross-add-or-update v-if="gongzixinxiCrossAddOrUpdateFlag" :parent="this" ref="gongzixinxiCrossaddOrUpdate"></gongzixinxi-cross-add-or-update>
...
import gongzixinxiCrossAddOrUpdate from "../gongzixinxi/add-or-update";
export default {
  data() {
    return {
      searchForm: {
      ...
      gongzixinxiCrossAddOrUpdateFlag: false,
  ...
  methods: {
    ...
    gongzixinxiCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.gongzixinxiCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','yonghu');
      this.$nextTick(() => {
      this.$refs.gongzixinxiCrossaddOrUpdate.init(row.id,type);
      });
    },
    init () {
