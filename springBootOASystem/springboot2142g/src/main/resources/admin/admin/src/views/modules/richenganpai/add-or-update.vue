    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="日程内容" prop="richengneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="日程内容"
                  v-model="ruleForm.richengneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.richengneirong" label="日程内容" prop="richengneirong">
                    <span>{{ruleForm.richengneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shijian = true;
          ...
          if(o=='richengneirong'){
            this.ruleForm.richengneirong = obj[o];
	    this.ro.richengneirong = true;
            continue;
          }
          if(o=='yonghuming'){
      ...
      this.$http({
		...
		if(json.zhiwei!=''&&json.zhiwei){
          ...
          this.$message.error(data.msg);
            ...
            this.leixingOptions = "工作安排,活动安排,其他".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
