<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="早退次数" prop="zaotuicishu">
          <el-input v-model="ruleForm.zaotuicishu" 
              placeholder="早退次数" clearable  :readonly="ro.zaotuicishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="早退次数" prop="zaotuicishu">
              <el-input v-model="ruleForm.zaotuicishu" 
                placeholder="早退次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="迟到次数" prop="chidaocishu">
          <el-input v-model="ruleForm.chidaocishu" 
              placeholder="迟到次数" clearable  :readonly="ro.chidaocishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="迟到次数" prop="chidaocishu">
              <el-input v-model="ruleForm.chidaocishu" 
                placeholder="迟到次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="请假次数" prop="qingjiacishu">
          <el-input v-model="ruleForm.qingjiacishu" 
              placeholder="请假次数" clearable  :readonly="ro.qingjiacishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="请假次数" prop="qingjiacishu">
              <el-input v-model="ruleForm.qingjiacishu" 
                placeholder="请假次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="旷工次数" prop="kuanggongcishu">
          <el-input v-model="ruleForm.kuanggongcishu" 
              placeholder="旷工次数" clearable  :readonly="ro.kuanggongcishu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="旷工次数" prop="kuanggongcishu">
              <el-input v-model="ruleForm.kuanggongcishu" 
                placeholder="旷工次数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  data() {
	...
	userid : false,
      ...
      rules: {
          ...
          qingjiacishu: [
                { required: true, message: '请假次数不能为空', trigger: 'blur' },
          ],
          kuanggongcishu: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chidaocishu = true;
          ...
          if(o=='qingjiacishu'){
            this.ruleForm.qingjiacishu = obj[o];
	    this.ro.qingjiacishu = true;
            continue;
          }
          if(o=='kuanggongcishu'){
            this.ruleForm.kuanggongcishu = obj[o];
	    this.ro.kuanggongcishu = true;
            continue;
          }
          if(o=='userid'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shangbankaoqin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shangbankaoqinCrossAddOrUpdateFlag = false;
                  this.parent.search();
