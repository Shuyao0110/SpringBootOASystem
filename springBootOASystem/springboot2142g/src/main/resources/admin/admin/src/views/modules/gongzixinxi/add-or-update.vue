<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="福利" prop="fuli">
          <el-input v-model="ruleForm.fuli" 
              placeholder="福利" clearable  :readonly="ro.fuli"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="福利" prop="fuli">
              <el-input v-model="ruleForm.fuli" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="扣费" prop="koufei">
          <el-input v-model="ruleForm.koufei" 
              placeholder="扣费" clearable  :readonly="ro.koufei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="扣费" prop="koufei">
              <el-input v-model="ruleForm.koufei" 
                placeholder="扣费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	riqi : false,
      ...
      rules: {
          ...
          koufei: [
                { required: true, message: '扣费不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
          shifagongzi: [
  ...
  computed: {
    shifagongzi: {
      get: function () {
        return 0+parseFloat(this.ruleForm.jibengongzi==""?0:this.ruleForm.jibengongzi)+parseFloat(this.ruleForm.jiabangongzi==""?0:this.ruleForm.jiabangongzi)+parseFloat(this.ruleForm.fuli==""?0:this.ruleForm.fuli)-parseFloat(this.ruleForm.shebao==""?0:this.ruleForm.shebao)-parseFloat(this.ruleForm.koufei==""?0:this.ruleForm.koufei) || 0
      }
    },
  },
  created() {
